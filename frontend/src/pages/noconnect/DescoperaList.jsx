  ...
  return (
    <li className='modf1:h-110 relative group overflow-hidden border border-button/20 rounded-lg'>
      ...
      <div className='absolute bottom-0 bg-background/70 w-full px-4 py-6 space-y-2'>
        ...
        <button onClick={()=>navigate("/contact")} className='cursor-pointer flex items-center bg-button px-4 py-1.5 transition duration-300 hover:bg-button/70 rounded-lg'><p>{props.button}</p> <FaArrowRight className='text-[14px] ml-3 mt-0.5'/></button>
