...
const adaugaInfoPolitica=(index)=>{


const lista=[...hotel.politici];


lista[index].informatii.push(
informatiePolitica
);
...
const adaugaInfoFacilitate=(index)=>{
...
onChange={handleChange}
  className='border border-button/30 w-full h-20 resize-none outline-0 mt-1 rounded-sm pl-3 pr-12.5 scrollbar-thin py-1.5' placeholder='' maxLength={150} id=""></textarea>
              <p className='absolute text-[11.5px] text-gray-400 right-3.5 bottom-1.5'><span></span>/150</p>
            </div>
          </div>
...
!hotel.stare_activare_hotel
 ...
 className={`w-10 h-5 cursor-pointer  shrink-0  rounded-full relative transition-all duration-300 ease-in-out ${activareButon===false?"bg-gray-400":"bg-button"}`}>
